...
class HetNode2VecSkipGramEnsmallen(Node2VecEnsmallen):
    """Class providing HetNode2Vec SkipGram implemeted in Rust from Ensmallen."""
    ...
    def __init__(
        ...
        """Create new abstract HetNode2Vec method.
