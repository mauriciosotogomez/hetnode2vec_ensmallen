"""Module providing HetNode2Vec CBOW model implementation."""
from typing import Optional, Dict, Any
from embiggen.embedders.ensmallen_embedders.node2vec import Node2VecEnsmallen


class HetNode2VecCBOWEnsmallen(Node2VecEnsmallen):
    """Class providing HetNode2Vec CBOW implemeted in Rust from Ensmallen."""
